...
# Function to check if watchdog.exe is running
...
def restart_blocker():
    blocker_path = r"C:\Users\Kusal Darshana\AppData\LocalLow\Temp\Microsoft\OPC\watchdog.exe"  # Adjust the path if needed
